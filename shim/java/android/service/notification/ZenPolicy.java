...
public final class ZenPolicy implements Parcelable {
    public static final int CONVERSATION_SENDERS_ANYONE = 0;
    public static final int CONVERSATION_SENDERS_IMPORTANT = 0;
    public static final int CONVERSATION_SENDERS_NONE = 0;
    public static final int CONVERSATION_SENDERS_UNSET = 0;
    public static final int PEOPLE_TYPE_ANYONE = 0;
    public static final int PEOPLE_TYPE_CONTACTS = 0;
    public static final int PEOPLE_TYPE_NONE = 0;
    public static final int PEOPLE_TYPE_STARRED = 0;
    public static final int PEOPLE_TYPE_UNSET = 0;
    public static final int STATE_ALLOW = 0;
