...
public class BinaryLayoutParser {
    ...
    static {
        ...
        VIEW_CLASS_MAP.put("RecyclerView", "androidx.recyclerview.widget.RecyclerView");
        ...
        FQN_CLASS_MAP.put("androidx.recyclerview.widget.RecyclerView", "androidx.recyclerview.widget.RecyclerView");
        ...
        FQN_CLASS_MAP.put("androidx.appcompat.widget.AppCompatTextView", "androidx.appcompat.widget.AppCompatTextView");
        ...
        FQN_CLASS_MAP.put("androidx.appcompat.widget.AppCompatImageView", "androidx.appcompat.widget.AppCompatImageView");
        FQN_CLASS_MAP.put("androidx.appcompat.widget.LinearLayoutCompat", "android.widget.LinearLayout");
        FQN_CLASS_MAP.put("com.facebook.shimmer.ShimmerFrameLayout", "com.facebook.shimmer.ShimmerFrameLayout");
        FQN_CLASS_MAP.put("com.mcdonalds.mcduikit.widget.McDMutedVideoView", "com.mcdonalds.mcduikit.widget.McDMutedVideoView");
