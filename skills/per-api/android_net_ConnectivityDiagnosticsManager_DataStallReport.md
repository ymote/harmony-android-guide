...
|---|---|---|---|---|---|---|
| `getDetectionMethod` | `int getDetectionMethod()` | 6 | partial | moderate | `getDefaultNet` | `getDefaultNet(callback: AsyncCallback<NetHandle>): void` |
| `getReportTimestamp` | `long getReportTimestamp()` | 5 | partial | moderate | `reportNetDisconnected` | `reportNetDisconnected(netHandle: NetHandle, callback: AsyncCallback<void>): void` |
...
|---|---|---|---|
| `DataStallReport` | 4 | composite | throw UnsupportedOperationException |
