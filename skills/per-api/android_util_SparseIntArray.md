...
| `get` | `int get(int)` | 10 | direct | trivial | `getOAID` | `getOAID(callback: AsyncCallback<string>): void` |
| `get` | `int get(int, int)` | 10 | direct | trivial | `getOAID` | `getOAID(callback: AsyncCallback<string>): void` |
| `size` | `int size()` | 10 | direct | trivial | `size` | `size: number` |
| `setValueAt` | `void setValueAt(int, int)` | 9 | direct | easy | `setValue` | `setValue(value: number): void` |
| `removeAt` | `void removeAt(int)` | 9 | direct | easy | `remove` | `remove(logType: string, logName: string): void` |
| `valueAt` | `int valueAt(int)` | 8 | direct | easy | `value` | `value: number` |
| `append` | `void append(int, int)` | 8 | direct | easy | `append` | `append?: boolean` |
...
| `indexOfValue` | `int indexOfValue(int)` | 7 | near | moderate | `indexOfLink` | `indexOfLink?: string` |
