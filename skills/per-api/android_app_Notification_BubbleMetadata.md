...
|---|---|---|---|---|---|---|
| `getAutoExpandBubble` | `boolean getAutoExpandBubble()` | 6 | partial | moderate | `getTopAbility` | `getTopAbility(): Promise<ElementName>` |
...
|---|---|---|---|
| `isNotificationSuppressed` | 5 | partial | Return safe default (null/false/0/empty) |
